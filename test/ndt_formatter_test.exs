defmodule XMLStreamTools.NativeDataType.FormatterDefaultTest do
  use ExUnit.Case
...
#  alias XMLStreamTools.NativeDataType.Meta, as: NDT_Meta
  ...
  alias XMLStreamTools.NativeDataType.FormatterDefault, as: NDT_FormatterDefault

  doctest XMLStreamTools.NativeDataType.FormatterDefault
