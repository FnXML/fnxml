defmodule FnXML.Event.Preprocess.NormalizeTest do
  use ExUnit.Case, async: true

  alias FnXML.Event.Preprocess.Normalize
  ...
  describe "line_endings_stream/1" do
    test "normalizes CRLF in stream" do
      chunks = ["hello\r\n", "world"]
      result = chunks |> Normalize.line_endings_stream() |> Enum.join()
      assert result == "hello\nworld"
    end
